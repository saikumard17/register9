    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-40">
                        <span class="db"><img src="${contextPath}/resources/assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <br>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="${contextPath}/login">
                        <div class="row p-b-30">
                            ...
                            <span>${message}</span>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="username" autofocus="true" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                          		...
                          		<span ><font color="white">${error}</font></span>
                          		<br>
